    ...
    <View style={styles.home}>
      ...
      {mode === "success" ?
        <View style={styles.sucessView}>
          <Text style={styles.title}>You took your {date.toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</Text>
      ...
      {mode === "error" ?
        <View style={styles.errorView}>
            <Text style={styles.title}>You haven't taken your {date.toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</Text>
            <Text style={styles.title}>{medName}</Text>
            <TouchableOpacity
